...
| --------------------------- | ----------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------- |
| Analyst (Mary)              | `bmad-agent-analyst`          | `BP`, `RS`, `CB`, `DP`             | Brainstorm Project, Research, Create Brief, Document Project                                        |
...
| QA Engineer (Quinn)         | `bmad-agent-qa`               | `QA`                               | Automate (generate tests for existing features)                                                     |
